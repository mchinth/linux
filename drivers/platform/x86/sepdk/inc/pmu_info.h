...
static const PMU_INFO_NODE pmu_info_list[] = {
	...
	// CTI number = 127
	{ 0x6, 0x55, 0x5, 0x9, clx_msr_list, skx_pci_list,
	  server_common_mmio_list },
	...
	// CTI number = 104
	{ 0x6, 0x56, 0x0, 0xF, bdx_msr_list, bdw_de_pci_list,
	  client_common_mmio_list },

	// CTI number = 105
	{ 0x6, 0x47, 0x0, 0xF, hsw_msr_list, NULL, client_common_mmio_list },

	// CTI number = 102
	{ 0x6, 0x57, 0x0, 0xF, knl_msr_list, knl_pci_list,
	  server_common_mmio_list },
	...
	// CTI number = 99
	{ 0x6, 0x3F, 0x0, 0xF, hsx_msr_list, hsx_pci_list,
	  server_common_mmio_list },
	...
	// CTI number = 94
	{ 0x6, 0x45, 0x0, 0xF, hsw_ult_msr_list, NULL,
	  client_common_mmio_list },

	// CTI number = 92
	{ 0x6, 0x3E, 0x0, 0xF, ivt_msr_list, ivt_pci_list,
	  server_common_mmio_list },
	...
	// CTI number = 85
	{ 0x6, 0x2D, 0x0, 0xF, jkt_msr_list, jkt_pci_list,
	  server_common_mmio_list },
	...
	// CTI number = 125
	{ 0x6, 0x6A, 0x0, 0xF, icx_r_msr_list, icx_r_pci_list,
	  icx_mmio_info_list },
	...
	// CTI number = 132
	{ 0x6, 0x55, 0xA, 0xF, clx_msr_list, cpx_pci_list,
	  server_common_mmio_list },
	...
	// NDA
	// CTI number = 144
	{ 0x6, 0x6C, 0x0, 0xF, icx_r_msr_list, icx_r_pci_list,
	  icx_mmio_info_list },

	// CTI number = 120
	{ 0x6, 0x85, 0x0, 0xF, knl_msr_list, knl_pci_list,
	  server_common_mmio_list },
	...
	// CTI number = 131
	{ 0x6, 0x8F, 0x0, 0xF, plat4_msr_list, plat4_pci_list,
	  plat4_mmio_info_list },

	// PRIVATE
	// CTI number = 121
	{ 0x6, 0x99, 0x9, 0xF, plat2_msr_list, plat2_pci_list,
	  icx_mmio_info_list },
	...
	// CTI number = 149
	{ 0x6, 0xAD, 0x0, 0xF, plat3_msr_list, NULL, plat3_mmio_info_list },
	...
	// CTI number = 154
	{ 0x6, 0xAC, 0x0, 0xF, plat5_msr_list, NULL, plat5_mmio_info_list },

	// CTI number = 155
	{ 0x6, 0xAA, 0x0, 0xF, plat5_msr_list, NULL, plat5_mmio_info_list },
