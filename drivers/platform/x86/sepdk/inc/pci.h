 ...
 */
extern int __weak pmt_telem_get_next_endpoint(int start);
 ...
 */
extern struct telem_endpoint *__weak pmt_telem_register_endpoint(int devid);
 ...
 */
extern void __weak pmt_telem_unregister_endpoint(struct telem_endpoint *ep);
 ...
 * * -EINVAL     - @info is NULL
 */
extern int __weak pmt_telem_get_endpoint_info(int devid,
 ...
 *                            is the devid
 */
extern int __weak pmt_telem_register_notifier(struct notifier_block *nb);
 ...
 *
 */
extern int __weak pmt_telem_unregister_notifier(struct notifier_block *nb);
