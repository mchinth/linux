...
static U32 mmio_client_pmu1_common_offset[] = { 0x5040, 0x5044, 0x5048, 0x5050,
						0x5054, 0x5058, 0 };

static U32 mmio_pmu2_offset[] = { 0x250, 0x254, 0x258, 0x25c,
				  0x260, 0x264, 0x268, 0 };

static U32 mmio_pmu3_common_offset[] = { 0x3008, 0x3010, 0x3018, 0x3020, 0x3028,
					 0x1008, 0x1010, 0x1018, 0x2008, 0 };

static U32 mmio_pmu4_offset[] = { 0x91B8, 0x91B9, 0x91BA, 0x91BB,
				  0x91bc, 0x91c0, 0x91c4, 0 };

static U32 mmio_pmu5_common_offset[] = { 0x500, 0x508, 0x400, 0x408, 0x418,
					 0x420, 0x428, 0x430, 0x438, 0x440,
					 0x448, 0x450, 0x458, 0x460, 0x468,
					 0x470, 0x478, 0x480, 0x488, 0x490,
					 0x498, 0x4a0, 0 };

static U32 mmio_bxt_dvt_pmu1_offset[] = { 0x6868, 0x686C, 0 };
...
static U32 mmio_tgl_pmu1_offset[] = {
	...
	0x14308, 0x14310, 0x14700, 0x14708, 0x14710, 0x14718, 0
};
...
static U32 mmio_pmu6_offset[] = {
	...
	0x70020, 0x75020, 0x79020, 0x7E020, 0x82020, 0x87020, 0x8B020, 0
};
...
static U32 mmio_pmu1_offset_2[] = {
	...
	0x24020, 0x28020, 0x2C020, 0
};

static U32 mmio_pmu1_offset_0[] = { 0x1C0,   0x1C4,   0x101C0, 0x101C4, 0x1D0,
				    0x1D4,   0x1D8,   0x1DC,   0x1E0,   0x101D0,
				    0x101D4, 0x101D8, 0x101DC, 0x101E0, 0xD9E8,
				    0xD9F0,  0xD9F8,  0xDA00,  0xDA08,  0x1D9E8,
				    0x1D9F0, 0x1D9F8, 0x1DA00, 0x1DA08, 0xD840,
				    0xD858,  0xD8A0,  0x1D840, 0x1D858, 0x1D8A0,
				    0 };
...
static U32 mmio_pmu8_offset[] = {
	...
	0x7100, 0x7140, 0x7180, 0x71C0, 0x7200, 0x7240, 0x7280,
};
...
static PMU_MMIO_UNIT_INFO_NODE tgl_mmio_info_list[] = {
	...
	{ { { { 0, 2, 0, 0x10 } }, 0, MMIO_SINGLE_BAR_TYPE, 0, 0x0007FFFFFF000 },
	  { { { 0, 0, 0, 0 } }, 0, MMIO_SINGLE_BAR_TYPE, 0, 0x0 },
	  mmio_pmu2_offset },
	{ { { { 0, 2, 0, 0x10 } }, 0, MMIO_SINGLE_BAR_TYPE, 0, 0 },
	  { { { 0, 0, 0, 0 } }, 0, MMIO_SINGLE_BAR_TYPE, 0, 0x0 },
	  mmio_pmu4_offset },
	{ { { { 0, 0, 0, 0 } }, 0, 0, 0, 0x0 },
	  { { { 0, 0, 0, 0 } }, 0, 0, 0, 0x0 },
