...
#define JKTUNC_QPILL_MM0_DID                                                   \
	0x3C86 // --- QPILL0 PerfMon MM Config DID --- B:D 1:8:6
...
#define JKTUNC_QPILL_MM1_DID                                                   \
	0x3C96 // --- QPILL1 PerfMon MM Config DID --- B:D 1:9:6
#define JKTUNC_QPILL_MCFG_DID                                                  \
	0x3C28 // --- QPILL1 PerfMon MCFG DID --- B:D 0:5:0
#define JKTUNC_QPILL0_D2C_DID                                                  \
	0x3C80 // --- D2C QPILL Port 1 config DID B:D:F X:8:0
#define JKTUNC_QPILL1_D2C_DID                                                  \
	0x3C90 // --- D2C QPILL Port 2 config DID B:D:F X:9:0
