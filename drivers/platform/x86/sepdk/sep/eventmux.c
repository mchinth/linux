 ...
 */
static VOID
eventmux_Allocate_Groups(PVOID params)
{
	U32          this_cpu;
	CPU_STATE    cpu_state;
	U32          dev_idx;
 ...
 */
static VOID
eventmux_Deallocate_Groups(PVOID params)
{
	U32          this_cpu;
	CPU_STATE    cpu_state;
	U32          dev_idx;
 ...
 */
static VOID
eventmux_Prepare_Timer_Threads(PVOID arg)
{
	U32          this_cpu;
	CPU_STATE    pcpu;
	U32          dev_idx;
 ...
 */
static VOID
eventmux_Start_Timers(PVOID arg)
{
	U32           this_cpu;
	CPU_STATE     pcpu;
	U32           dev_idx;
