 ...
 */
static VOID
valleyview_VISA_Initialize(VOID *param)
{
 ...
 */
static VOID
valleyview_VISA_Enable_PMU(PVOID param)
{
	U32       this_cpu;
	CPU_STATE pcpu;
 ...
 */
static VOID
valleyview_VISA_Disable_PMU(PVOID param)
{
	U32       this_cpu;
	CPU_STATE pcpu;
 ...
 */
static VOID
valleyview_VISA_Clean_Up(VOID *param)
{
	SEP_DRV_LOG_TRACE_IN("Param: %p.", param);
 ...
 */
static VOID
valleyview_VISA_Read_PMU_Data(PVOID param, U32 dev_idx)
{
	U32       j;
 ...
 */
static VOID
valleyview_Trigger_Read(PVOID param, U32 id, U32 read_from_intr)
{
	U64 *data = (U64 *)param;
	U32  cur_grp;
	ECB  pecb;
